...
export default function RefinementPanel({ hypothesis, novelty, signalText, onSelectHypothesis }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-4">
        ...
        >
          {novelty === 'exact_match'
            ? 'This exact experiment has been published. Ask what angle remains unexplored, or how to meaningfully differentiate your approach.'
            : 'Similar work exists in this area. Describe what direction you want to explore and receive three reformulated hypotheses.'}
        </p>
                ...
                <div className="space-y-2">
                  ...
                  {suggestions.map((s, i) => (
                    <motion.button
                      ...
                      className="w-full text-left px-4 py-3 border rounded text-xs leading-relaxed transition-all group"
                      style={{
                        fontFamily: 'var(--font-source-sans), sans-serif',
                  ...
                  {/* Streaming indicator while more suggestions load */}
